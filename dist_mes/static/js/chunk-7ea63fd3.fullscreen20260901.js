  ...
  ["chunk-7ea63fd3"],
  {
    "1e4b": function(module, exports, __webpack_require__) {
      ...
      function devicePanel(h) {
        var rows = [
          ["数控加工中心", "RUNNING", false],
          ["视觉检测工位", "RUNNING", false],
          ["机器人装配岛", "RUNNING", false],
          ["智能包装单元", "STANDBY", true]
        ];
        return panel(h, "设备运行状态", "DEVICE / 01", [
      ...
      function capacityPanel(h) {
        ...
        return panel(h, "产线负荷", "CAPACITY / 02", [
      ...
      function videoStage(h) {
        return h("div", { staticClass: "dashboard-video-layer" }, [
          h("video", {
            staticClass: "dashboard-video",
            attrs: { autoplay: "", loop: "", playsinline: "", preload: "metadata", "data-video-slot": "ue5-production-line" },
            domProps: { muted: true }
          }),
          h("div", { staticClass: "video-fallback" }, [
            ...
            h("div", { staticClass: "video-placeholder-copy" }, [
              h("div", { staticClass: "video-placeholder-title" }, ["UE5 产线视频全屏背景预留"]),
              h("div", { staticClass: "video-placeholder-sub" }, ["FULL-SCREEN PRODUCTION LINE DIGITAL TWIN"])
            ])
          ])
        ]);
      }
      ...
      function visualClear(h) {
        return h("section", { staticClass: "screen-visual-clear" }, [
          h("div", { staticClass: "video-stage-label" }, ["UE5 VIDEO SOURCE / WAITING"]),
          h("div", { staticClass: "equipment-tag tag-a" }, ["CNC-01", h("span", ["● 正常运行"])]),
          h("div", { staticClass: "equipment-tag tag-b" }, ["ROBOT-02", h("span", ["● 自动模式"])]),
          h("div", { staticClass: "equipment-tag tag-c" }, ["QC-03", h("span", ["● 检测通过"])]),
          h("div", { staticClass: "visual-focus" }, [h("i"), h("span", ["生产线主视区"])] )
        ]);
      }

      function oeePanel(h) {
        var details = [["开动率", "91.2%"], ["性能率", "87.6%"], ["良品率", "98.4%"]];
        return panel(h, "综合设备效率", "OEE / 03", [
      ...
      function trendPanel(h) {
        ...
        return panel(h, "生产节拍趋势", "TREND / 05", [
      ...
      var IndustrialDashboard = {
        ...
        data: function() {
          return {
            ...
            clockTimer: null,
            metrics: [
              { icon: "▦", label: "今日计划", value: "2,400", unit: "PCS", trend: "PLAN" , color: "#41c8ff" },
              { icon: "▶", label: "当前产量", value: "1,836", unit: "PCS", trend: "+8.2%", color: "#2bf3d1" },
            ...
            h("div", { staticClass: "screen-shell" }, [
              h("header", { staticClass: "screen-header" }, [
                h("div", { staticClass: "screen-brand" }, [
                  ...
                  h("span", ["BSQ · MES / DIGITAL FACTORY"])
                ]),
                h("div", { staticClass: "screen-title-wrap" }, [
                  h("h1", { staticClass: "screen-title" }, ["智能制造生产运行中心"]),
                  h("div", { staticClass: "screen-title-en" }, ["INTELLIGENT MANUFACTURING OPERATION CENTER"])
                ]),
